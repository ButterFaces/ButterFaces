...
@ResourceDependencies({
        ...
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-number.css", target = "head"),
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-link.css", target = "head"),
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-prettyprint.css", target = "head"),
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-section.css", target = "head"),
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-table.css", target = "head"),
        ...
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-tree.css", target = "head"),
        ...
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-markdown.css", target = "head"),
        @ResourceDependency(library = "butterfaces-dist", name = "css/butterfaces-treebox.css", target = "head"),
        ...
        @ResourceDependency(library = "butterfaces-js", name = "butterfaces-messages.js", target = "head"),
