...
public class Constants {
    ...
    public static final String FLOATING_STYLE_CLASS = "butterfaces-component-floating";
    public static final String NON_FLOATING_STYLE_CLASS = "butterfaces-component-non-floating";
    public static final String TEXT_AREA_MAXLENGTH_COUNTER_CLASS = "butterfaces-maxlength-counter";
    public static final String OUTERDIV_POSTFIX = "_outerComponentDiv";

    public static final String COMPONENT_STYLE_CLASS = "butterfaces-component";
    ...
    public static final String BOOTSTRAP_COL_SM_1 = "col-sm-1";
    public static final String BOOTSTRAP_COL_SM_2 = "col-sm-2";
    public static final String BOOTSTRAP_COL_SM_3 = "col-sm-3";
    public static final String BOOTSTRAP_COL_SM_4 = "col-sm-4";
    public static final String BOOTSTRAP_COL_SM_5 = "col-sm-5";
    public static final String BOOTSTRAP_COL_SM_6 = "col-sm-6";
    public static final String BOOTSTRAP_COL_SM_7 = "col-sm-7";
    public static final String BOOTSTRAP_COL_SM_8 = "col-sm-8";
