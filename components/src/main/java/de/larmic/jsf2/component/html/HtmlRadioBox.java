...
public class HtmlRadioBox extends HtmlSelectOneRadio implements HtmlInputComponent {
	...
	public static final String COMPONENT_TYPE = "de.larmic.component.radioBox";
	public static final String COMPONENT_FAMILY = "de.larmic.component.family";
	public static final String RENDERER_TYPE = "de.larmic.jsf2.renderkit.html_basic.RadioBoxRenderer";
