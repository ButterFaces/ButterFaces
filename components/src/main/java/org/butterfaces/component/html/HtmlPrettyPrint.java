...
public class HtmlPrettyPrint extends UIComponentBase {
    ...
    public static final String COMPONENT_TYPE = "org.butterfaces.component.prettyprint";
    public static final String COMPONENT_FAMILY = "org.butterfaces.component.family";
    public static final String RENDERER_TYPE = "org.butterfaces.renderkit.html_basic.PrettyPrintRenderer";
