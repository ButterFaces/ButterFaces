...
import de.larmic.butterfaces.component.renderkit.html_basic.TooltipRenderer;
...
public class FacesContextMockCreator {
    ...
    private static RenderKit createRenderKitMock(FacesContext facesContextMock, UIComponent... elStackComponents) {
        ...
        // handle renderer
        when(renderKitMock.getRenderer("de.larmic.butterfaces.component.family", "de.larmic.butterfaces.component.renderkit.html_basic.TooltipRenderer"))
