...
import org.butterfaces.component.showcase.table.example.TableWebXmlExample;
import org.butterfaces.component.showcase.tree.SelectionAjaxType;
...
public class TableShowcase extends AbstractCodeShowcase implements Serializable {
    ...
    private JavaCodeExample createMyBeanCodeExample() {
        ...
        if (this.selectionAjaxType == SelectionAjaxType.AJAX) {
            myBean.addImport("org.butterfaces.event.TableSingleSelectionListener");
        }
        if (useTableModel) {
            myBean.addImport("org.butterfaces.model.table.TableModel");
            myBean.addImport("org.butterfaces.model.table.DefaultTableModel");
        }
        if (showRefreshButton) {
            myBean.addImport("org.butterfaces.model.table.TableToolbarRefreshListener");
        }
