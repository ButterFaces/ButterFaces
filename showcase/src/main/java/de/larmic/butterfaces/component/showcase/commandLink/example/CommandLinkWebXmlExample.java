 ...
 */
package de.larmic.butterfaces.component.showcase.commandLink.example;
...
public class CommandLinkWebXmlExample extends WebXmlCodeExample {
    public CommandLinkWebXmlExample() {
        ...
        appendInnerContent("     <param-name>de.larmic.butterfaces.ajaxProcessingTextOnRequest</param-name>");
